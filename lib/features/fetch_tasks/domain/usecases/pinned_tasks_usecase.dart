...
class GetPinnedTasksUsecase extends BaseUseCase<List<TaskEntity>, String> {
  final FetchTasksRepository repository;

  GetPinnedTasksUsecase(this.repository);

  @override
  Future<Either<Failure, List<TaskEntity>>> call(String username) async {
    return await repository.getAllPinnedTasks(username);
  }
}
