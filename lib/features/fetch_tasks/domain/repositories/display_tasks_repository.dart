...
abstract class FetchTasksRepository {
  Future<Either<Failure, List<TaskEntity>>> getAllTasks(String username);
  Future<Either<Failure, List<TaskEntity>>> getAllPinnedTasks(String username);
  Future<Either<Failure, List<TaskEntity>>> getAllTasksByStatus(String username, TaskStatus status);
  Future<Either<Failure, List<SubtaskEntity>>> getAllSubtasksByTaskId(String username, String taskId);
}
